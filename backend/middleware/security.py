...
PUBLIC_PATHS = {"/api/health", "/docs", "/openapi.json", "/redoc", "/api/auth/confirm-email", "/api/admin/migrate", "/api/admin/reset-admin-password", "/api/admin/generate-test-data", "/api/admin/backfill-all-users", "/api/admin/debug-raw-profiles"}
